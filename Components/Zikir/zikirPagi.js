...
export default class ZikirPagi extends React.Component {
  render() {
    return (
      <View styles={Styles.ViewComponentZikir}>
        <View style={Styles.ViewHeader}>
          <TouchableOpacity
            ...
            {arrow}
            <Text style={Styles.TextTitleViewHeader}> Dzikir Pagi</Text>
          </TouchableOpacity>
        </View>
        <View style={{width: '100%', height: '100%', paddingBottom: '16%'}}>
          <ScrollView>
            {Data.zikirPagi.map(res => (
              <View
                key={res.id}
                style={
                  res.color === 1
